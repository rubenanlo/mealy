...
const en = {
  ...
  autoHint: 'Paste a link (website, Instagram, TikTok), the recipe text, or just describe the dish in your own words.',
  pastePlaceholder: 'Paste a link, or describe the dish',
  pasteFromClipboard: 'Paste the copied link',
...
const es: typeof en = {
  ...
  autoHint: 'Pega un enlace (web, Instagram, TikTok), el texto de la receta, o describe el plato con tus palabras.',
  pastePlaceholder: 'Pega un enlace o describe el plato',
  pasteFromClipboard: 'Pegar el enlace copiado',
...
const fr: typeof en = {
  ...
  autoHint: 'Collez un lien (site web, Instagram, TikTok), le texte de la recette, ou décrivez le plat avec vos mots.',
  pastePlaceholder: 'Collez un lien ou décrivez le plat',
  pasteFromClipboard: 'Coller le lien copié',
...
const it: typeof en = {
  ...
  autoHint: 'Incolla un link (sito web, Instagram, TikTok), il testo della ricetta, o descrivi il piatto a parole tue.',
  pastePlaceholder: 'Incolla un link o descrivi il piatto',
  pasteFromClipboard: 'Incolla il link copiato',
