...
const en = {
  ...
  familySection: 'Family preferences',
  personSection: 'Person preferences',
  quotas: 'Protein quotas',
  categoryFish: 'Fish',
  categoryMeat: 'Meat',
...
const es: typeof en = {
  ...
  familySection: 'Preferencias de la familia',
  personSection: 'Preferencias por persona',
  quotas: 'Cuotas de proteína',
...
const fr: typeof en = {
  ...
  familySection: 'Préférences de la famille',
  personSection: 'Préférences par personne',
  quotas: 'Quotas de protéines',
...
const it: typeof en = {
  ...
  familySection: 'Preferenze della famiglia',
  personSection: 'Preferenze per persona',
  quotas: 'Quote proteiche',
  categoryFish: 'Pesce',
  categoryMeat: 'Carne',
  categoryVegetarian: 'Vegetariano',
